<!-- Searchbar -->
<?php if ($_SERVER['REQUEST_URI'] === "/tickets") { ?>
    <div class="search-container-tickets">
        <div class="search-bar-tickets">
        ...
        <div class="search-by">
            <button class="search-button active-search" value="3">Title</button>
            <button class="search-button" value="4">Employee</button>
            <button class="search-button" value="5">Date</button>
        </div>
    </div>
<?php } else if ($_SERVER['REQUEST_URI'] === "/staff") { ?>
...
<?php } else { ?>
    <div class="search-container">
        <div class="search-bar">
            <input type="text" class="search" disabled readonly>
            <svg class="search-icon" xmlns="http://www.w3.org/2000/svg" width="35.997" height="36.004" viewBox="0 0 35.997 36.004">
                <path id="Icon_awesome-search" data-name="Icon awesome-search" fill="gray" d="M35.508,31.127l-7.01-7.01a1.686,1.686,0,0,0-1.2-.492H26.156a14.618,14.618,0,1,0-2.531,2.531V27.3a1.686,1.686,0,0,0,.492,1.2l7.01,7.01a1.681,1.681,0,0,0,2.384,0l1.99-1.99a1.7,1.7,0,0,0,.007-2.391Zm-20.883-7.5a9,9,0,1,1,9-9A8.995,8.995,0,0,1,14.625,23.625Z" />
            </svg>
        </div>
    </div>
<?php } ?>
